...
Command to run at the prompt:
    python -m unittest -v tests/normtest/ryan-joiner/test_rj_correlation_plot.py
    or
    python -m unittest -b tests/normtest/ryan-joiner/test_rj_correlation_plot.py
...
### FUNCTION IMPORT ###
from normtest.normtest import rj_correlation_plot
...
class Test_rj_correlation_plot(unittest.TestCase):
    ...
    def test_basic_plot(self):
        ...
        fig1_base_path = Path("tests/normtest/ryan-joiner/figs_rj_correlation_plot/fig1.png")

        fig, ax = plt.subplots()
        result = rj_correlation_plot(ax, self.x_data)
        fig1_file = Path("tests/normtest/ryan-joiner/figs_rj_correlation_plot/fig1_test.png")
    ...
    def test_plot_weighted_true(self):
        ...
        fig2_base_path = Path("tests/normtest/ryan-joiner/figs_rj_correlation_plot/fig2.png")

        fig, ax = plt.subplots()
        result = rj_correlation_plot(ax, x, weighted=True)
        fig2_file = Path("tests/normtest/ryan-joiner/figs_rj_correlation_plot/fig2_test.png")
